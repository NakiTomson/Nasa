package com.example.dmiryz.nasa.models
...
class Photo {
    ...
    val imageUrl: String
        get() { //https://api.nasa.gov/EPIC/archive/enhanced/2016/12/04/png/epic_RBG_20161204003633.png?api_key=DEMO_KEY
            ...
            sb
                ...
                .append(image).append(".png?api_key=")
                .append(KEY)
            return sb.toString()
        }

    companion object {
        private const val KEY = "bvHFulvj4IYd35wfWWAb0qaWGamtavbSx7KgMVPc"
    }
}